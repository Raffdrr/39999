...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="animate-page-content-enter flex flex-col flex-1 h-full overflow-y-auto no-scrollbar pb-8">
      ...
      <div className="relative flex flex-col items-center p-5 bg-white dark:bg-slate-800 rounded-2xl shadow-lg mb-5">
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-lg mb-5">
            ...
            <div className="px-4 pb-4 animate-slide-down space-y-3">
              {objectives.slice(0, 3).map((obj: GamificationObjective) => (
                  <div key={obj.id} className={`flex items-center p-3 rounded-lg border shadow-sm ${obj.isCompleted ? 'bg-green-50 dark:bg-green-500/10 border-green-200 dark:border-green-500/20' : 'bg-slate-50 dark:bg-slate-700/50 border-slate-200 dark:border-slate-700'}`}>
                      ...
                      {!obj.isCompleted && <span className="text-xs font-bold text-amber-600 dark:text-amber-400">+{obj.xpValue} XP</span>}
                  </div>
              ))}
            </div>
          )}
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-4 mt-5">
