    ...
    <ModalWrapper open={true} onClose={onClose}>
      <div className="bg-white dark:bg-black rounded-2xl shadow-2xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="overflow-y-auto p-5 sm:p-6 space-y-4 sm:space-y-5 text-slate-700 dark:text-slate-300">
          <p className="text-md sm:text-lg text-center font-semibold text-purple-600 dark:text-purple-400">Sblocca il massimo dalla tua esperienza SocialMix!</p>
          <div className="space-y-3 sm:space-y-4">
            <div
              className="bg-purple-50/70 dark:bg-purple-500/10 p-3.5 sm:p-4 rounded-xl border-2 border-purple-300 dark:border-purple-500/30 shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
              onClick={() => {
            ...
            >
              <div className="flex flex-col sm:flex-row justify-between items-center mb-1">
                <h4 className="font-bold text-lg sm:text-xl text-purple-700 dark:text-purple-300 mb-1 sm:mb-0">Premium Mensile</h4>
                <p className="text-xl sm:text-2xl font-bold text-purple-700 dark:text-purple-300">€4<span className="text-md sm:text-lg">.99</span><span className="text-xs sm:text-sm font-normal text-slate-500 dark:text-slate-400">/mese</span></p>
              </div>
              <ul className="list-disc list-inside space-y-0.5 sm:space-y-1 text-xs sm:text-sm text-slate-600 dark:text-slate-300 pl-1">
            ...
            <div
              className="relative bg-teal-50/70 dark:bg-teal-500/10 p-3.5 sm:p-4 rounded-xl border-2 border-teal-400 dark:border-teal-500/30 shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
              onClick={() => {
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center mb-1">
                <h4 className="font-bold text-lg sm:text-xl text-teal-700 dark:text-teal-300 mb-1 sm:mb-0">Premium Annuale</h4>
                <p className="text-xl sm:text-2xl font-bold text-teal-700 dark:text-teal-300">€47<span className="text-md sm:text-lg">.99</span><span className="text-xs sm:text-sm font-normal text-slate-500 dark:text-slate-400">/anno</span></p>
              </div>
              <ul className="list-disc list-inside space-y-0.5 sm:space-y-1 text-xs sm:text-sm text-slate-600 dark:text-slate-300 pl-1">
                <li>Tutti i vantaggi del Mensile</li>
                <li><span className="font-semibold text-teal-600 dark:text-teal-400">Sconto del 20%</span> rispetto al piano mensile</li>
